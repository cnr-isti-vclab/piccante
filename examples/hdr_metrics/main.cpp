...
int main(int argc, char *argv[])
{
    ...
    if(img0.isValid() && (bCreate || bLoaded)) {
        ...
        ssim.update(-1.0f, -1.0f, -1.0f, -1.0f, true, pic::MD_PU21);
